...
def main():
	#def strip_barcode_addons(seqfile1,seqfile1,pdiffs=0,separate_barfile=False,test=False):
	...
	parser.add_argument('-pdiffs',type=int,help='Number of primer bp mismatches allowed (default is 0).',metavar='<int>',default=1)
